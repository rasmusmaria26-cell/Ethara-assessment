  ...
  return (
    <>
      <style>{`
        ...
        .ethara-root.mounted .submit-btn { animation: fadeUp 0.5s ease both; animation-delay: 540ms; }
        .ethara-root.mounted .form-footer { animation: fadeIn 0.4s ease both; animation-delay: 640ms; }
      ...
      <div className={`ethara-root${mounted ? ' mounted' : ''}`}>
        <div className="left-panel">
          ...
          <div className="left-bottom">
            <span className="left-tag">// welcome back</span>
            <span className="left-desc">Your workspace is waiting.</span>
